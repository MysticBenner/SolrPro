...
public class IndexSearcher {
    ...
    public void search01() throws Exception{
        ...
        System.out.println("查询的结果总数为："+count);
        for(SolrDocument doc : list){
            System.out.println("Id为："+doc.get("id"));
            System.out.println("商品名称为："+doc.get("product_name"));
            System.out.println("商品种类为："+doc.get("product_catalog"));
            System.out.println("商品价格为："+doc.get("product_price"));
            System.out.println("商品图片地址为："+doc.get("product_picture"));
            System.out.println("----------------------------------查询结束分界线");
        }
    }
    @Test
